...
const ResetPasswordForm=()=>{
    ...
    const sendResetRequest = async () => {
        try {
          ...
          // Proceed to show the modal for OTP input
  ...
  footer={null} // Remove footer, we will add custom buttons below
>
  {
    step === 1 ?
    (
...
{alertInfo.visible && (
        <Alert
          ...
          showIcon
          closable
          style={{ marginBottom: '16px', zIndex: 1000, position: 'absolute', top: 0, right: 0 }} // Adjust the positioning as needed
        />
      )}
  </Card>
    );
