...
import { EditOutlined, EllipsisOutlined, SettingOutlined,DollarOutlined,GiftOutlined,ReadOutlined } from '@ant-design/icons';
    ...
    return(
      ...
      description={
        <div>
          ...
          <div style={{ marginTop: '16px', textAlign: 'center', fontSize: '24px', fontWeight: 'bold',color:'#1F1F1F' }} className='BookTitle'>
        Дон Кихот
      </div>
